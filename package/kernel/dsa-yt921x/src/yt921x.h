...
#define  YT922X_PORT_STATUS_LINK		BIT(8)
...
#define YT92XX_SERDES_MODE_10GBASER		YT922X_SERDES_MODE(6)
...
struct yt921x_port {
	...
	/* YT9224 fixed CPU link recovery, protected by reg_lock. */
	struct delayed_work cpu_mac_work;
	bool fixed_usxgmii_10g;
	bool conduit_operational;

	/* YT9224 bridge state, protected by reg_lock. */
	struct net_device *yt922x_bridge;
	u8 yt922x_stp_state;
	bool yt922x_learning;
};
...
struct yt921x_priv {
	...
	bool cpu_mac_stopping;
	bool yt922x_bridge_broken;
	...
	/* Static VID 0/1 aliases, protected by reg_lock. */
	struct list_head yt922x_fdb_entries;
};
